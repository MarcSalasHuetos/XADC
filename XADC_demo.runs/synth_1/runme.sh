...
HD_PWD='C:/Users/marcs/OneDrive/Escritorio/Codes/vhd/XADC_demo/XADC_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SI_CH_XADC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SI_CH_XADC.tcl
