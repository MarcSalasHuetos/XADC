...
HD_PWD='C:/Users/marcs/OneDrive/Escritorio/Codes/vhd/XADC_demo/XADC_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SI_CH_XADC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SI_CH_XADC.tcl -notrace
